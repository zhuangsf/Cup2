...
public class BluetoothLeService extends Service {
    private final static String TAG = "jockeyBluetoothService";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                Utils.Log("xxxxxxxxxxxxxxxxxx onCharacteristicRead:"+characteristic.getValue().toString()+":"+DeviceControlActivity.bin2hex(characteristic.getValue().toString()));
            }
        }
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
                                            BluetoothGattCharacteristic characteristic) {
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            Utils.Log("xxxxxxxxxxxxxxxxxx onCharacteristicChanged:"+characteristic);
        }
        @Override
        public void onCharacteristicWrite (BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status){
//        	 Utils.Log("xxxxxxxxxxxxxxxxxx onCharacteristicWrite:"+characteristic+",status:"+status);
        	 Utils.Log("xxxxxxxxxxxxxxxxxx onCharacteristicWrite:"+characteristic.getValue().toString()+":"+DeviceControlActivity.bin2hex(characteristic.getValue().toString()));
        }
    };
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            Utils.Log("broadcastUpdate data.length = "+ data.length);
            ...
            if (data != null && data.length > 0) {
                ...
                Utils.Log("broadcastUpdate just need:"+ stringBuilder.toString());
            }
        }
        sendBroadcast(intent);
    }
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
   	 ...
   	 Utils.Log("xxxxxxxxxxxxxxxxxx writeCharacteristic:"+characteristic.getValue().toString()+":"+DeviceControlActivity.bin2hex(characteristic.getValue().toString()));
